...
export default function AuthPage() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      toast.success("Email verified successfully! 🎉 Welcome to HireMate AI!");
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Handle verification required (both register and unverified login)
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        {/* Right Panel - Auth Form or Verification */}
            ...
            {showVerification ? (
              <div className={styles.verificationContainer}>
                ...
                <div className={styles.verifyIconWrapper}>
                  ...
                  <div className={styles.verifyIconPulse} />
                </div>
                ...
                <p className={styles.verifyEmail}>{verificationEmail}</p>
                ...
                <div className={styles.otpContainer}>
                  {otpValues.map((val, i) => (
                    <input
                      ...
                      className={`${styles.otpInput} ${val ? styles.otpFilled : ""} ${otpError ? styles.otpError : ""}`}
                      autoFocus={i === 0}
                      id={`otp-input-${i}`}
                    />
                  ))}
