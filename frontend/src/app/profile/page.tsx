  ...
  return (
    <div className={styles.page}>
      ...
      <footer className={nav.footer}>
        <div className={nav.footerInner}>
          <div className={nav.footerTop}>
            <div className={nav.footerBrand}>
              <Link href="/" className={nav.footerLogo}>
                <svg width="28" height="28" viewBox="0 0 40 40" fill="none">
                  <rect x="2" y="2" width="36" height="36" rx="10" fill="url(#profFtGrad)" />
                  <path d="M12 14h16M12 20h10M12 26h14" stroke="var(--logo-stroke)" strokeWidth="2.5" strokeLinecap="round" />
                  <circle cx="30" cy="26" r="4" fill="var(--logo-stroke)" opacity="0.8" />
                  <path d="M29 25.5l1 1 2-2" stroke="var(--logo-check-bg)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <defs>
                    <linearGradient id="profFtGrad" x1="0" y1="0" x2="40" y2="40">
                      <stop stopColor="var(--logo-grad-start)" />
                      <stop offset="1" stopColor="var(--logo-grad-end)" />
                    </linearGradient>
                  </defs>
              ...
              <p className={nav.footerTagline}>
                Intelligent interview preparation &amp; career development platform.
              </p>
            </div>

            <div className={nav.footerLinks}>
              <div className={nav.footerCol}>
                <h4 className={nav.footerColTitle}>Product</h4>
              ...
              <div className={nav.footerCol}>
                <h4 className={nav.footerColTitle}>Company</h4>
                <a href="#">About</a>
                <a href="#">Blog</a>
                <a href="#">Careers</a>
                <a href="#">Contact</a>
              ...
              <div className={nav.footerCol}>
                <h4 className={nav.footerColTitle}>Legal</h4>
          ...
          <div className={nav.footerBottom}>
            <p>© 2026 HireMate AI. All rights reserved.</p>
            <div className={nav.footerSocials}>
